...
- [Menu Framework](https://outerwildsmods.com/mods/menuframework/) — by _nebula  
- [Custom Ship Log Modes](https://outerwildsmods.com/mods/customshiplogmodes/) — by dgarro  
- [OW Fix Plugin Types Serialization](https://outerwildsmods.com/mods/owfixplugintypesserialization/) — by JohnCorby  
- [Vanilla Fix](https://outerwildsmods.com/mods/vanillafix/) — by JohnCorby  
- [Common Camera Utility](https://outerwildsmods.com/mods/commoncamerautility/) — by xen  
